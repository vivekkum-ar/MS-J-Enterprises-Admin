...
const BillPage: React.FC<BillPageProps> = ({}) => {
  ...
  return (
    <div className="WordSection1">
        <table className="MsoNormalTable" border={0} cellSpacing={0} cellPadding={0} align="left" style={{borderCollapse: 'collapse',   marginLeft: '6.75pt', marginRight: '6.75pt'}}>
          <tbody><tr style={{  height: '19.85pt'}}>
              <td width={728} colSpan={2} style={{width: '545.75pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '19.85pt'}}>
                <p className="MsoNormal"  style={{marginTop: '0cm', marginRight: '-16.7pt', marginBottom: '0cm', marginLeft: '-18.0pt', textAlign: 'center', lineHeight: 'normal'}}><b><span style={{fontSize: '40.0pt', fontFamily: '"Century",serif'}}>&nbsp;</span></b><b><span lang="EN-US" style={{fontSize: '40.0pt', fontFamily: '"Century",serif'}}>M/S JAYA PRASAD</span></b></p>
              </td>
            </tr>
            <tr style={{ height: '19.85pt'}}>
              <td width={728} colSpan={2} style={{width: '545.75pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '19.85pt'}}>
                <p className="MsoNormal"  style={{marginTop: '6.0pt', marginRight: '-16.55pt', marginBottom: '0cm', marginLeft: '0cm', textAlign: 'center', lineHeight: '50%'}}><span lang="EN-US" style={{}}><img width={698} height={45} id="_x0000_i1025" src="./header.jpg" /></span></p>
              </td>
            </tr>
            <tr style={{ height: '19.85pt'}}>
        ...
        <table className="MsoNormalTable" border={0} cellSpacing={0} cellPadding={0} align="left" width={764} style={{width: '573.35pt', borderCollapse: 'collapse',   marginLeft: '6.75pt', marginRight: '6.75pt'}}>
          <tbody><tr style={{  height: '12.1pt'}}>
              <td width={377} colSpan={5} valign="top" style={{width: '282.75pt', border: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', background: '#D0CECE', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal"  style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', textAlign: 'center', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '14.0pt', fontFamily: '"Arial",sans-serif', color: 'black'}}>Bill To
                      Party</span></b></p>
              </td>
              <td width={387} colSpan={4} valign="top" style={{width: '290.6pt', borderTop: 'solid windowtext 1.5pt', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', background: '#D0CECE', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal"  style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', textAlign: 'center', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '14.0pt', fontFamily: '"Arial",sans-serif', color: 'black'}}>Place of
                      Supply</span></b></p>
              </td>
            </tr>
            <tr style={{ height: '12.1pt'}}>
              <td width={377} colSpan={5} valign="top" style={{width: '282.75pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span className="GramE"><b><span lang="EN-US" style={{fontSize: '14.0pt'}}>Name :</span></b></span><span lang="EN-US" style={{fontSize: '14.0pt'}}> Feedback Infra Pvt. Ltd. </span></p>
              </td>
              <td width={387} colSpan={4} valign="top" style={{width: '290.6pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{fontSize: '14.0pt'}}>&nbsp;</span></p>
              </td>
            </tr>
            <tr style={{ height: '12.1pt'}}>
              <td width={377} colSpan={5} valign="top" style={{width: '282.75pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span className="GramE"><b><span lang="EN-US" style={{fontSize: '14.0pt'}}>Address :</span></b></span><span lang="EN-US" style={{fontSize: '14.0pt'}}> <span className="SpellE">Ashoknagar,Ranchi</span></span></p>
              </td>
              <td width={387} colSpan={4} valign="top" style={{width: '290.6pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span className="SpellE"><span className="GramE"><span lang="EN-US" style={{fontSize: '14.0pt'}}>Ashoknagar</span></span></span><span className="GramE"><span lang="EN-US" style={{fontSize: '14.0pt'}}> ,</span></span><span lang="EN-US" style={{fontSize: '14.0pt'}}> Ranchi ,
                    Jharkhand</span></p>
              </td>
            </tr>
            <tr style={{ height: '12.1pt'}}>
              <td width={377} colSpan={5} valign="top" style={{width: '282.75pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span className="GramE"><b><span lang="EN-US" style={{fontSize: '14.0pt'}}>GSTIN :</span></b></span><span lang="EN-US" style={{fontSize: '14.0pt'}}> -</span></p>
              </td>
              <td width={387} colSpan={4} valign="top" style={{width: '290.6pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{fontSize: '14.0pt'}}>Pin-834002</span></p>
              </td>
            </tr>
            <tr style={{ height: '12.1pt'}}>
              <td width={377} colSpan={5} valign="top" style={{width: '282.75pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '14.0pt'}}>State:</span></b><span lang="EN-US" style={{fontSize: '14.0pt'}}> Jharkhand</span></p>
              </td>
              <td width={387} colSpan={4} valign="top" style={{width: '290.6pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '14.0pt'}}>&nbsp;</span></b></p>
              </td>
            </tr>
            <tr style={{ height: '12.1pt'}}>
              <td width={377} colSpan={5} valign="top" style={{width: '282.75pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span className="SpellE"><b><span lang="EN-US" style={{fontSize: '14.0pt'}}>Zipcode</span></b></span><b><span lang="EN-US" style={{fontSize: '14.0pt'}}>:</span></b><span lang="EN-US" style={{fontSize: '14.0pt'}}> 834002</span></p>
              </td>
              <td width={387} colSpan={4} valign="top" style={{width: '290.6pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '14.0pt'}}>&nbsp;</span></b></p>
              </td>
            ...
            <tr style={{ height: '12.1pt'}}>
              <td width={377} colSpan={5} valign="top" style={{width: '282.75pt', border: 'solid windowtext 1.5pt', borderTop: 'none', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '14.0pt'}}>VEHICLE NO.:</span></b><span lang="EN-US" style={{fontSize: '14.0pt'}}> JH-05CH-2817</span></p>
              </td>
            ...
            <tr style={{ height: '12.1pt'}}>
              <td width={37} rowSpan={2} valign="top" style={{width: '27.95pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Sno</span></b></p>
              </td>
              <td width={189} rowSpan={2} valign="top" style={{width: '141.4pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Service
              ...
              <td width={47} rowSpan={2} valign="top" style={{width: '35.45pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Unit</span></b></p>
              </td>
              <td width={76} rowSpan={2} valign="top" style={{width: '2.0cm', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Base Rate</span></b></p>
              </td>
              <td width={151} colSpan={2} rowSpan={2} valign="top" style={{width: '4.0cm', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '12.1pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr style={{ height: '13.45pt'}}>
              <td width={66} valign="top" style={{width: '49.6pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Rate</span></b></p>
              </td>
              <td width={66} valign="top" style={{width: '49.65pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Amount</span></b></p>
              </td>
            </tr>
            <tr style={{ height: '13.45pt'}}>
              <td width={37} valign="top" style={{width: '27.95pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>1.</span></b></p>
              </td>
              <td width={189} valign="top" style={{width: '141.4pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Rent-Taxi/Cab
                      Service</span></b></p>
              </td>
            ...
            <tr style={{ height: '13.45pt'}}>
              <td width={37} valign="top" style={{width: '27.95pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>2.</span></b></p>
              </td>
              <td width={189} valign="top" style={{width: '141.4pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
            ...
            <tr style={{ height: '13.45pt'}}>
              <td width={37} valign="top" style={{width: '27.95pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>3.</span></b></p>
              </td>
              <td width={189} valign="top" style={{width: '141.4pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Parking</span></b></p>
              </td>
              <td width={47} valign="top" style={{width: '35.45pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{}}>&nbsp;1</span></p>
              </td>
            ...
            <tr style={{ height: '13.45pt'}}>
              <td width={37} valign="top" style={{width: '27.95pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>4.</span></b></p>
              </td>
              <td width={189} valign="top" style={{width: '141.4pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Toll Tax</span></b></p>
              </td>
              <td width={47} valign="top" style={{width: '35.45pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{}}>&nbsp;1</span></p>
              </td>
            ...
            <tr style={{ height: '13.45pt'}}>
              <td width={37} valign="top" style={{width: '27.95pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>5.</span></b></p>
              </td>
              <td width={189} valign="top" style={{width: '141.4pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Overtime</span></b></p>
              </td>
              <td width={47} valign="top" style={{width: '35.45pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{}}>&nbsp;1</span></p>
              </td>
            ...
            <tr style={{ height: '13.45pt'}}>
              <td width={37} valign="top" style={{width: '27.95pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>6.</span></b></p>
              </td>
              <td width={189} valign="top" style={{width: '141.4pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Extra used for</span></b></p>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>&nbsp;<span className="GramE">Distance(</span>in Kms)</span></b></p>
              </td>
              <td width={47} valign="top" style={{width: '35.45pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{}}>&nbsp;1</span></p>
              </td>
            ...
            <tr style={{ height: '13.45pt'}}>
              <td width={37} valign="top" style={{width: '27.95pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>7.</span></b></p>
              </td>
            ...
            <tr style={{ height: '13.45pt'}}>
              <td width={349} colSpan={4} valign="top" style={{width: '261.5pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal"  style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', textAlign: 'center', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Total Bill amount in Words</span></b></p>
              </td>
              <td width={284} colSpan={4} valign="top" style={{width: '212.65pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{fontSize: '12.0pt'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr style={{ height: '13.45pt'}}>
              <td width={349} colSpan={4} rowSpan={3} valign="top" style={{width: '261.5pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.5pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal"  style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', textAlign: 'center', lineHeight: 'normal'}}><span className="GramE"><span lang="EN-US" style={{fontSize: '12.0pt'}}>Forty Three</span></span><span lang="EN-US" style={{fontSize: '12.0pt'}}> Thousand</span></p>
                <p className="MsoNormal"  style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', textAlign: 'center', lineHeight: 'normal'}}><span lang="EN-US" style={{fontSize: '12.0pt'}}>Eight Hundred <span className="GramE">Sixty Five</span></span></p>
                <p className="MsoNormal"  style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', textAlign: 'center', lineHeight: 'normal'}}><span lang="EN-US" style={{fontSize: '12.0pt'}}>INR</span></p>
              </td>
              <td width={284} colSpan={4} valign="top" style={{width: '212.65pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Add:
                      IGST&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; =0</span></b></p>
              </td>
              <td width={132} valign="top" style={{width: '99.2pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '13.45pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{}}>&nbsp;&nbsp;&nbsp;&nbsp; n/A</span></p>
            ...
            <tr style={{ height: '10.85pt'}}>
              <td width={349} colSpan={4} valign="top" style={{width: '261.5pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '10.85pt'}}>
                <p className="MsoNormal"  style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', textAlign: 'center', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Bank Details</span></b></p>
              </td>
              <td width={416} colSpan={5} rowSpan={4} valign="top" style={{width: '11.0cm', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.5pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '10.85pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><i><span lang="EN-US" style={{fontFamily: '"Bahnschrift Light SemiCondensed",sans-serif'}}>&nbsp; <span style={{color: 'gray'}}>Certifies that the
                        particular given above are true and correct</span></span></i></p>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}>{/*[if gte vml 1]><v:shapetype
   ...
   style='position:absolute;margin-left:0;margin-top:0;width:117pt;height:35.25pt;
   z-index:251658240;visibility:visible;mso-wrap-style:square;
   mso-width-percent:0;mso-height-percent:0;mso-wrap-distance-left:6pt;
   ...
   o:allowoverlap="f">
   <v:imagedata src="fk%20infra%20bill504_files/image003.png"/>
   <w:wrap type="square" anchory="line"/>
  </v:shape><![endif]*/}{/*[if !vml]*/}<img width={156} height={47} src="./sign.png"/>{/*[endif]*/}
  {/* <b><span lang="EN-US" style={{fontSize: '12.0pt'}}>&nbsp;&nbsp;&nbsp;
                    </span></b><span lang="EN-US" style={{}}>&nbsp;</span><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></b>*/}</p> 
                {/* <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{fontSize: '12.0pt'}}>&nbsp;</span></p> */}
                {/* <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><span lang="EN-US" style={{fontSize: '12.0pt'}}>&nbsp;</span></p> */}
                <p className="MsoNormal"  style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', textAlign: 'center', lineHeight: 'normal'}}><span className="SpellE"><span lang="EN-US" style={{fontSize: '12.0pt'}}>Authorised</span></span><span lang="EN-US" style={{fontSize: '12.0pt'}}> Signatory: M/S
                    Jaya Prasad</span></p>
              </td>
            </tr>
            <tr style={{ height: '17.55pt'}}>
              <td width={349} colSpan={4} valign="top" style={{width: '261.5pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '17.55pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Bank A/c No. : </span></b><span lang="EN-US" style={{fontSize: '12.0pt'}}>50100243426111</span></p>
              </td>
            </tr>
            <tr style={{ height: '10.05pt'}}>
              <td width={349} colSpan={4} valign="top" style={{width: '261.5pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '10.05pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Bank IFSC : </span></b><span lang="EN-US" style={{fontSize: '12.0pt'}}>HDFC0004208</span></p>
              </td>
            </tr>
            <tr style={{ height: '26.8pt'}}>
              <td width={349} colSpan={4} valign="top" style={{width: '261.5pt', borderTop: 'none', borderLeft: 'solid windowtext 1.5pt', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.5pt', padding: '0cm 5.4pt 0cm 5.4pt', height: '26.8pt'}}>
                <p className="MsoNormal" style={{marginTop: '0cm', marginRight: '-21.2pt', marginBottom: '0cm', marginLeft: '0cm', lineHeight: 'normal'}}><b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Bank A/c Holder -</span></b><span lang="EN-US" style={{fontSize: '12.0pt'}}>Jaya Prasad<b> </b></span></p>
              </td>
            </tr>
            <tr style={{ }}>
        ...
        <p className="MsoNormal" style={{marginRight: '-21.2pt'}}><span lang="EN-US" style={{}}>&nbsp;</span></p>
        <table className="MsoNormalTable" border={0} cellSpacing={0} cellPadding={0} align="left" style={{borderCollapse: 'collapse',   marginLeft: '6.75pt', marginRight: '6.75pt'}}>
          <tbody><tr style={{height: '19.85pt'}}>
